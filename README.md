...
A distributed news aggregation platform built with **FastAPI**, **PostgreSQL**, and **React** that continuously ingests software engineering news from multiple providers, processes and ranks articles through an asynchronous pipeline, and serves all client requests directly from a cached database.
