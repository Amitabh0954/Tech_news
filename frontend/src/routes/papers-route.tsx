...
import { PaperCard } from "@/components/news/paper-card";
import { usePapersFeed } from "@/features/articles/queries";

export function PapersRoute() {
  const { data, isLoading, isError, error, fetchNextPage, hasNextPage, isFetchingNextPage } = usePapersFeed();
