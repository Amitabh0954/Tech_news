...
export function SearchRoute() {
  ...
  return (
    <section className="border border-border bg-panel p-6 dark:border-white/10">
      <div className="text-[11px] uppercase tracking-[0.22em] text-slate-500 dark:text-slate-500">Search</div>
      ...
      <input
        ...
        className="mt-5 w-full border border-border bg-background px-4 py-3 text-sm text-slate-900 outline-none dark:border-white/10 dark:text-white"
      />
